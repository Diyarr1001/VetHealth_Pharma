      ...
      <section className="container mx-auto px-4 md:px-8 mb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <div className="relative h-[400px] rounded-3xl overflow-hidden group">
            <Image src="https://images.pexels.com/photos/4421550/pexels-photo-4421550.jpeg" alt="Sterile Manufacturing line" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
          ...
          <div className="grid grid-rows-2 gap-8 h-[400px]">
            <div className="relative rounded-3xl overflow-hidden group">
              <Image src="https://images.pexels.com/photos/5118461/pexels-photo-5118461.jpeg" alt="Quality Control Lab" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
                <h3 className="text-xl font-bold text-white">Advanced QC Laboratory</h3>
              </div>
            </div>
            <div className="relative rounded-3xl overflow-hidden group">
              <Image src="https://plus.unsplash.com/premium_photo-1661501492574-53aaa43edc70?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Feed Additives Plant" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-6">
