          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {STATS.map((stat, index) => (
              <motion.div
                ...
                className={`bg-white border border-slate-100 p-8 rounded-3xl relative overflow-hidden group hover:border-primary/30 shadow-sm hover:shadow-xl hover:shadow-primary/10 transition-all ${index === 2 ? "sm:col-span-2 bg-gradient-to-tr from-white to-violet-50/50" : ""
                  }`}
              >
